...
<div>
    ...
    <div class="managerSettingContent">
        ...
        <div class="iconLegend">
            <ul>
                <li>
                    <asp:Image ID="HostHasSettingImage" runat="server" ImageUrl="~/Providers/HtmlEditorProviders/DNNConnect.CKE/js/ckeditor/images/HostHasSetting.png" />&nbsp;
                    <asp:Label runat="server" ID="HostHasSettingLabel"></asp:Label>
                </li>
                <li>
                    <asp:Image ID="HostNoSettingImage" runat="server" ImageUrl="~/Providers/HtmlEditorProviders/DNNConnect.CKE/js/ckeditor/images/HostNoSetting.png"/>&nbsp;
                    <asp:Label runat="server" ID="HostNoSettingLabel"></asp:Label>
                </li>
                <li>
                    <asp:Image ID="PortalHasSettingImage" runat="server" ImageUrl="~/Providers/HtmlEditorProviders/DNNConnect.CKE/js/ckeditor/images/PortalHasSetting.png" />&nbsp;
                    <asp:Label runat="server" ID="PortalHasSettingLabel"></asp:Label>
                </li>
                <li>
                    <asp:Image ID="PortalNoSettingImage" runat="server" ImageUrl="~/Providers/HtmlEditorProviders/DNNConnect.CKE/js/ckeditor/images/PortalNoSetting.png"/>&nbsp;
                    <asp:Label runat="server" ID="PortalNoSettingLabel"></asp:Label>
                </li>
                <li>
                    <asp:Image ID="PageHasSettingImage" runat="server" ImageUrl="~/Providers/HtmlEditorProviders/DNNConnect.CKE/js/ckeditor/images/PageHasSetting.png"/>&nbsp;
                    <asp:Label runat="server" ID="PageHasSettingLabel"></asp:Label>
                </li>
                <li>
                    <asp:Image ID="PageNoSettingImage" runat="server" ImageUrl="~/Providers/HtmlEditorProviders/DNNConnect.CKE/js/ckeditor/images/PageNoSetting.png" />&nbsp;
                    <asp:Label runat="server" ID="PageNoSettingLabel"></asp:Label>
                </li>
                <li>
                    <asp:Image ID="ModuleHasSettingImage" runat="server" ImageUrl="~/Providers/HtmlEditorProviders/DNNConnect.CKE/js/ckeditor/images/ModuleHasSetting.png" />&nbsp;
                    <asp:Label runat="server" ID="ModuleHasSettingLabel"></asp:Label>
                </li>
                <li>
                    <asp:Image ID="ModuleNoSettingImage" runat="server" ImageUrl="~/Providers/HtmlEditorProviders/DNNConnect.CKE/js/ckeditor/images/ModuleNoSetting.png"/>&nbsp;
